  ...
  const addTodoContent = (
    <form className='flex items-end gap-2 justify-between w-full mb-3' onSubmit={handleAddTodo}>
        <div className='basis-full'>
          ...
          <input placeholder='Your todo' value={todoText} onChange={e => setTodoText(e.target.value)} type="text" className='w-full border border-[#dedede] outline-none focus:ring-4 focus-within:ring-blue-300 text-base rounded-md p-2 mt-2'/>
        </div>
